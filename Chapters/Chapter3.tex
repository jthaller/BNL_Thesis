...
What we want to know how to shift the weights of the functions. We want to know $\frac{\partial L}{\partial W}$, but it'll take some work to get there. Now, explicitly,
