...
\section{FEFF Simulations here?}
Not sure if this should go in this section. Maybe be relegated to the appendix? Basically just recap the intro of this article by them https://iopscience.iop.org/article/10.1088/1742-6596/430/1/012001/pdf  and that lecture on FEFF
\cite{feff-citation} \cite{feff-new-dev} \cite{rehr2010parameter}.
