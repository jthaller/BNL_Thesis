...
To check our FEFF simulation parameters, as well as the validity of the gaussian-weighted disorder technique, we compare the simulation data to experiental data.\todo[color=pink!40]{Can someone give me citations for these?} 

\begin{figure}[h]
	\centering
	\includegraphics[width=.7\linewidth]{Chapters/Figures/bulk_8nm_disorder_experimental_theory_comparison.png}
	\caption[Simulation vs. Experimental]{Comparing the bulk foil (blue) measurement to the 8~nm disordered nanoparticle (orange) measurement is an analog to comparing the simulated, non disordered FEFF spectrum (green) to the simulated disordered spectrum (red). The simulated disordered spectrum was weighted according to the gaussian $ N(0, 0.145)  $.}
