...
\usepackage{pdfpages} % needed to included signed last page
...
\setlength{\textheight}{9in} %originally 8.5
\setlength{\oddsidemargin}{0pt}
\setlength{\evensidemargin}{0pt}
\setlength{\topmargin}{0pt}
\setlength{\marginparsep}{0pt}
\setlength{\marginparwidth}{1in}
\linespread{1.3} % added 
...
{\huge Investigation of Bond Strain Effects\\on XANES Spectra\\\vspace{.7em}via Artificial Neural Networks} % \huge sets the font size.  Other options include things like \large, \Large, \small, \tiny, etc.  Investigation of Bond Strain Effects\\on XANES Spectra by\\Supervised Machine Learning
...
Master thesis submitted to the Faculty
...
September, 2021 % you might choose to set a permanent date, but \today will put in today's date
\end{center}
\end{titlepage}
...
% \bibliography calls the actual file that contains your bibliographic information.  This file can be generated by hand or in an automated way using software such as BibTeX.  Either works fine, but it is worth learning to use BibTex in the long term.  Take a look at the .bib file included here if you want to get some idea of the formatting required to create a bibliogarphy file of your own.
...
\pagebreak
% \chapter*{~}
% \input{Chapters/signaturePage.tex}
\includepdf[pages=-]{Chapters/just-signed-page.pdf}

% % \backmatter
% \pagebreak
% % \include{Chapters/signaturePage}
